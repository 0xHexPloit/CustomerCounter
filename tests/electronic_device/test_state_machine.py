...
def test_move_from_potential_arrival_to_in_mall_on_event_received():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    assert machine.current_state.id == "in_mall"


def test_move_from_potential_arrival_to_false_positive_if_receiving_no_event():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.no_event_received()
    assert machine.current_state.id == "false_positive"


def test_move_from_in_mall_to_potential_leaving_if_receiving_no_event():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    machine.no_event_received()
...
def test_should_return_to_in_mall_from_potential_leaving_if_receiving_event():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    machine.no_event_received()
    machine.event_received()
...
def test_should_stay_in_potential_leaving_on_no_event_received_if_number_attempts_still_positive():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    machine.no_event_received()
    machine.no_event_received()
...
def test_should_move_from_potential_leaving_to_left_if_no_event_received_and_no_more_attempts_possible():
...
def test_should_decrement_number_attempts_when_receiving_no_event_on_potential_leaving_state():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    machine.no_event_received()
    machine.no_event_received()
...
def test_should_move_from_left_to_potential_arrival_when_receiving_event():
...
def test_should_move_from_false_positive_to_potential_arrival_when_receiving_event():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.no_event_received()
    machine.event_received()
...
def test_should_reset_remaining_potential_leaving_attempts_when_moving_from_left_to_potential_arrival():
...
def test_should_stay_in_mall_when_receiving_event():
    machine = ElectronicDevicePresenceMachine.build_default_machine()
    machine.event_received()
    machine.event_received()
...
def test_should_stay_in_left_when_receiving_no_event():
    machine = ElectronicDevicePresenceMachine(0)
    machine.event_received()
    machine.no_event_received()
    machine.no_event_received()
