from customercounter.electronic_device.state_machine import ElectronicDevicePresenceMachine
...
def test_should_decrement_number_attempts_when_receiving_no_probe_request_on_potential_leaving_state():
    ...
    assert remaining_attempts == settings.state_machine.attempts_in_potential_leaving - 1
