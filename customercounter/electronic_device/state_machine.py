...
class ElectronicDevicePresenceMachine(StateMachine):
    ...
    probe_request_received = (
        ...
        potential_leaving.to(in_mall, on="_reset_remaining_potential_leaving_attempts") |
    ...
    no_probe_request_received = (
        ...
        potential_leaving.to(potential_leaving, cond="_potential_leaving_attempts_still_positive") |
    ...
    def __init__(self, number_attempts_in_potential_leaving: int, *args, **kwargs):
        ...
        self.__initial_number_attempts_in_potential_leaving = number_attempts_in_potential_leaving
        self.__number_attempts_in_potential_leaving = number_attempts_in_potential_leaving
    
    @staticmethod
    def build_default_machine() -> "ElectronicDevicePresenceMachine":
        settings = get_app_settings()
        return ElectronicDevicePresenceMachine(settings.state_machine.attempts_in_potential_leaving)
    ...
    def _reset_remaining_potential_leaving_attempts(self):
        self.__number_attempts_in_potential_leaving = self.__initial_number_attempts_in_potential_leaving
